...
const SignUp = () => {
	...
	return (
		<div className="flex justify-center items-center flex-col min-w-screen lg:p-16 lg:py-24 py-16 px-0">
			<div className="w-full lg:w-[400px] flex flex-col items-center justify-center border-border/50 border-2 hover:border-border/70 transition-all duration-300 ease-in-out lg:px-12 lg:py-6 px-4 py-8 rounded-[1em]">
				<Formik
					initialValues={{
						email: '',
						password: '',
				...
				>
					{({ errors, touched, isSubmitting }) => (
						<Form className="w-full flex flex-col gap-2">
							...
							<Field
								className={cn(
									'p-2.5 px-3 rounded-lg border-2 border-border/50 hover:border-border/70 transition-all duration-300 ease-in-out bg-transparent focus-visible:border-border/70 focus-visible:outline-none',
									errors.name && touched.name && 'bg-destructive/10'
								)}
								id="name"
								name="name"
								type="text"
							...
							<Field
								className={cn(
									'p-2.5 px-3 rounded-lg border-2 border-border/50 hover:border-border/70 transition-all duration-300 ease-in-out bg-transparent focus-visible:border-border/70 focus-visible:outline-none',
									errors.college && touched.college && 'bg-destructive/10'
								)}
								id="college"
								name="college"
								type="text"
							...
							<Field
								className={cn(
									'p-2.5 px-3 rounded-lg border-2 border-border/50 hover:border-border/70 transition-all duration-300 ease-in-out bg-transparent focus-visible:border-border/70 focus-visible:outline-none',
									errors.semester && touched.semester && 'bg-destructive/10'
								)}
								id="semester"
								name="semester"
								type="number"
							...
							<Field
								...
								className={cn(
									'p-2.5 px-3 rounded-lg border-2 border-border/50 hover:border-border/70 transition-all duration-300 ease-in-out bg-transparent focus-visible:border-border/70 focus-visible:outline-none',
									errors.branchStream && touched.branchStream && 'bg-destructive/10'
								)}
								id="branchStream"
								name="branchStream"
							>
