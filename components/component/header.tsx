          ...
          <div className="px-8 lg:px-12 h-16 py-2 flex items-center">
            ...
            <nav className="ml-auto flex justify-center items-center gap-6 sm:gap-6">
                <div className="flex gap-2">
                  ...
                  <div className="flex justify-center items-center h-full border-primary border-border border-[1px] rounded-full ">
                      <img
                        draggable="false"
                        src="https://img.freepik.com/premium-vector/user-profile-icon-flat-style-member-avatar-vector-illustration-isolated-background-human-permission-sign-business-concept_157943-15752.jpg"
                        alt="User Image"
                        className='w-10 aspect-square object-cover rounded-full overflow-hidden scale-125'
                      />
                  </div>
                </Link>
                </div>
