...
export default function LandingPageTestimonials() {
	const heading = 'Students are our Greatest Inspiration';
			...
			<div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
					...
					{letters.map((letter, index) => (
						<motion.span
							className={`inline-block md:text-6xl text-3xl tracking-tight font-bold ${
								...
								letter.toLowerCase() === 'inspiration'
				...
				>
					<motion.div className="mb-8 sm:break-inside-avoid" variants={child} key={1}>
						<blockquote className="rounded-lg p-6 border-border/50 bg-background border-2 hover:border-border/70 transition-all duration-300 ease-in-out sm:p-8">
							<div className="flex items-center gap-4">
								<Image
									alt="Harjot Singh"
									src="/pfp-2-compressed-2.png"
									width={60}
									height={60}
								...
								<div>
									...
									<p className="mt-0.5 text-lg font-medium text-foreground">Harjot Singh</p>
								</div>
							</div>
					...
					<motion.div className="mb-8 sm:break-inside-avoid" variants={child} key={2}>
						<blockquote className="rounded-lg p-6 border-border/50 bg-background/80 backdrop-blur-sm border-2 hover:border-border/70 transition-all duration-300 ease-in-out sm:p-8">
							<div className="flex items-center gap-4">
								<Image
									alt="Harjot Singh"
									src="/pfp-2-compressed-2.png"
					...
					<motion.div className="mb-8 sm:break-inside-avoid" variants={child} key={3}>
						<blockquote className="rounded-lg p-6 border-border/50 bg-background/80 backdrop-blur-sm border-2 hover:border-border/70 transition-all duration-300 ease-in-out sm:p-8">
							<div className="flex items-center gap-4">
								<Image
									alt="Harjot Singh"
					...
					<motion.div className="mb-8 sm:break-inside-avoid" variants={child} key={4}>
						<blockquote className="rounded-lg p-6 border-border/50 bg-background/80 backdrop-blur-sm border-2 hover:border-border/70 transition-all duration-300 ease-in-out sm:p-8">
							<div className="flex items-center gap-4">
								<Image
									alt="Harjot Singh"
					...
					<motion.div className="mb-8 sm:break-inside-avoid" variants={child} key={5}>
						<blockquote className="rounded-lg p-6 border-border/50 bg-background/80 backdrop-blur-sm border-2 hover:border-border/70 transition-all duration-300 ease-in-out sm:p-8">
							<div className="flex items-center gap-4">
								<Image
									alt="Harjot Singh"
					...
					<motion.div className="mb-8 sm:break-inside-avoid" variants={child} key={6}>
						<blockquote className="rounded-lg p-6 border-border/50 bg-background/80 backdrop-blur-sm border-2 hover:border-border/70 transition-all duration-300 ease-in-out sm:p-8">
							<div className="flex items-center gap-4">
								<Image
									alt="Harjot Singh"
					...
					<motion.div className="mb-8 sm:break-inside-avoid" variants={child} key={7}>
						<blockquote className="rounded-lg p-6 border-border/50 bg-background/80 backdrop-blur-sm border-2 hover:border-border/70 transition-all duration-300 ease-in-out sm:p-8">
							<div className="flex items-center gap-4">
								<Image
									alt="Harjot Singh"
					...
					<motion.div className="mb-8 sm:break-inside-avoid" variants={child} key={8}>
						<blockquote className="rounded-lg p-6 border-border/50 bg-background/80 backdrop-blur-sm border-2 hover:border-border/70 transition-all duration-300 ease-in-out sm:p-8">
							<div className="flex items-center gap-4">
								<Image
									alt="Harjot Singh"
					...
					<motion.div className="mb-8 sm:break-inside-avoid" variants={child} key={9}>
						<blockquote className="rounded-lg p-6 border-border/50 bg-background/80 backdrop-blur-sm border-2 hover:border-border/70 transition-all duration-300 ease-in-out sm:p-8">
							<div className="flex items-center gap-4">
								<Image
									alt="Harjot Singh"
