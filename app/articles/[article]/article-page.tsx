	...
	return (
		<div className="flex justify-center items-center flex-col">
			...
			<div className="flex min-w-screen lg:px-16 px-4 justify-start items-center flex-col py-24 pb-96">
				<div className="self-start justify-self-start">
					...
					<div className="flex flex-col gap-3 mt-8">
						...
						<h2 className="lg:text-xl text-lg gap-2 inline-flex items-center justify-start ">
							...
							<div>
								Published on{' '}
								<span className="font-semibold">{new Date(article.created_at).toDateString()}</span>
							</div>
						</h2>
					</div>
				</div>
				...
				<div
					className="prose prose-headings:text-pretty lg:prose-lg prose-a:text-primary prose-headings:tracking-tight text-foreground/90 prose-headings:text-foreground"
